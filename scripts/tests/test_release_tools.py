    ...
    def test_apk_verifier_checks_exact_release_identity_and_notices(self) -> None:
        with tempfile.TemporaryDirectory() as directory:
            ...
            apkanalyzer.write_text(
                ...
                "version-code) echo 55 ;;\n"
                "version-name) echo 4.1.3 ;;\n"
                "min-sdk) echo 29 ;;\n"
                "target-sdk) echo 36 ;;\n"
...
class ReleasePolicyTest(unittest.TestCase):
    ...
    def test_current_and_legacy_rollout_is_publishable_and_user_facing(self) -> None:
        ...
        self.assertIn("Quest VD Wired v4.1.3 for Windows 10/11", readme)
        self.assertIn("v3.1.0 Legacy", readme)
        self.assertIn("gnirehtet-java-v3.1.0.zip", readme)
        self.assertIn("quest-vd-wired-v4.1.3-windows-x64.zip", readme)
        ...
        self.assertIn('versionCode = 55', android_v4)
        self.assertIn('versionName = "4.1.3"', android_v4)
        self.assertIn('<string name="app_name">Quest VD Wired</string>', android_strings)
        self.assertIn('version = "4.1.3"', rust_v4)
